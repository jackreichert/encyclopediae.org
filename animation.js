...
const institutions = [
    ...
    { name: 'Encyclopedia of Bologna', strength: 'World\'s oldest university in continuous operation' },
    { name: 'Encyclopedia of Jagiellonian', strength: 'Copernicus\'s astronomical revolution began here' },
    ...
    { name: 'Encyclopedia of Toronto', strength: 'Discovering insulin and pioneering AI' },
...
function isPositionValid(el, left, top) {
    ...
    const mainTextBounds = getElementBounds(mainText);
